"""Scraper for One Leisure St Neots badminton court availability."""
...
class OneLeisureStNeotsScraper(OneLeisureBaseScraper):
    """St Neots-specific GladstoneGo scraper using the shared OneLeisureBaseScraper."""

    CONFIG = OneLeisureConfig(
        facility_name="One Leisure St Neots",
        where_value="One Leisure St Neots",
        where_fallbacks=["St Neots"],
    )
