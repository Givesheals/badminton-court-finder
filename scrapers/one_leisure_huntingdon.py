"""Scraper for One Leisure Huntingdon badminton court availability."""
...
class OneLeisureHuntingdonScraper(OneLeisureBaseScraper):
    """Huntingdon-specific GladstoneGo scraper using the shared OneLeisureBaseScraper."""

    CONFIG = OneLeisureConfig(
        facility_name="One Leisure Huntingdon",
        where_value="One Leisure Huntingdon",
        where_fallbacks=["Huntingdon"],
    )
